...
namespace AlienProject
{
	...
	/// </summary>
	[RequireComponent(typeof(CAccelerationMovement))]
	...
	public class CAnimator : MonoBehaviour
	{
		...
		[Header("필요한 캐릭터 컴포넌트")]
		[SerializeField]
		private CAccelerationMovement _movementAction;
		[SerializeField]
		...
		private float RotationDegree
		{
			get
			{
				var translatedMovementInput = _movementAction.MovementDirection;
		...
		private void Awake()
		{
			_movementAction = GetComponent<CAccelerationMovement>();
